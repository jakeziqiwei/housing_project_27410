...
neighborhood_counts <- data.frame(table(categorical_features_clean$neighbourhood_cleansed))

names(neighborhood_counts) <- c("Neighborhood", "Count")
